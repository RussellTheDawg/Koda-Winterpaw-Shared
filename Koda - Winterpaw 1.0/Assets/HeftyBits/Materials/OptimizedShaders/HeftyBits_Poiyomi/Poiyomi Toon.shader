Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/b3c4574d155b8664293ed166fbc608a5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiFragData poiFragData)
			{
				...
				SSS.a = 1 - SSS.a;
				#endif
				float3 vLTLight = poiLight.direction + poiMesh.normals[0] * (0.275 /*_SSSDistortion*/);
				float flTDot = pow(saturate(dot(poiCam.viewDir, -vLTLight)), (35.3 /*_SSSSpread*/)) * (1.0 /*_SSSStrength*/);
				#ifdef UNITY_PASS_FORWARDBASE
				...
				#endif
				#if defined(POINT) || defined(SPOT)
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(1,1,1,1) * SSS.rgb * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(1,1,1,1) * SSS.rgb * poiLight.attenuation * lerp(1, poiFragData.baseColor, (0.0 /*_SSSBaseColorMix*/));
			}
			#endif
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float metallic = (0.25 /*_MochieMetallicMultiplier*/);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((1.0 /*_MochieGSAAEnabled*/))
				{
					...
					percepRough = GSAA_Filament(normals, percepRough, (0.138 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					if ((0.0 /*_Specular2ndLayer*/) == 1 && (1.0 /*_MochieSpecularStrength2*/) > 0)
					{
						percepRough2 = GSAA_Filament(normals, percepRough2, (0.138 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					}
				}
				...
				reflections *= poiThemeColor(poiMods, float4(0,0,0,1), (0.0 /*_MochieReflectionTintThemeIndex*/));
			...
			void CalculateUTSSpecular(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					specMask1 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_HighColor_Power*/)))) * (0.029 /*_Layer1Strength*/);
					specMask2 += pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/);
				}
				else
				{
					specMask1 += poiEdgeNonLinear(specArea, (1.0 - pow((0.0 /*_HighColor_Power*/), 5)), (0.588 /*_StylizedSpecularFeather*/)) * (0.029 /*_Layer1Strength*/);
				...
				#endif
				float finalSpecMask = min(min(specMask, poiLight.occlusion), attenuation) * (0.5 /*_StylizedSpecularStrength*/);
				switch((0.0 /*_Is_BlendAddToHiColor*/))
				{
					case 0:
					poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (0.0 /*_UseLightColor*/)), finalSpecMask);
					break;
					case 1:
					poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (0.0 /*_UseLightColor*/)) * finalSpecMask);
					break;
					case 2:
					poiFragData.baseColor = lerp(poiFragData.baseColor, blendScreen(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (0.0 /*_UseLightColor*/))), finalSpecMask);
					break;
					case 3:
					poiFragData.baseColor = lerp(poiFragData.baseColor, poiFragData.baseColor * specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.directColor, (0.0 /*_UseLightColor*/)), finalSpecMask);
					break;
				}
				float3 vSpecMask = 0;
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						if ((0.0 /*_Is_SpecularToHighColor*/))
						{
							vSpecMask = pow(specArea, exp2(lerp(11, 1, (0.0 /*_HighColor_Power*/)))) * (0.029 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
							vSpecMask = max(vSpecMask, pow(specArea, exp2(lerp(11, 1, (0.0 /*_Layer2Size*/)))) * (0.0 /*_Layer2Strength*/) * poiLight.vAttenuation[index]);
						}
						else
						{
							vSpecMask = poiEdgeNonLinear(specArea, (1.0 - pow((0.0 /*_HighColor_Power*/), 5)), (0.588 /*_StylizedSpecularFeather*/)) * (0.029 /*_Layer1Strength*/) * poiLight.vAttenuation[index];
						...
						float finalSpecMask = min(min(vSpecMask, poiLight.occlusion), attenuation) * (0.5 /*_StylizedSpecularStrength*/);
						switch((0.0 /*_Is_BlendAddToHiColor*/))
						{
							case 0:
							poiFragData.baseColor = lerp(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (0.0 /*_UseLightColor*/)), finalSpecMask);
							break;
							case 1:
							poiLight.finalLightAdd += max(0, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (0.0 /*_UseLightColor*/)) * finalSpecMask);
							break;
							case 2:
							poiFragData.baseColor = lerp(poiFragData.baseColor, blendScreen(poiFragData.baseColor, specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (0.0 /*_UseLightColor*/))), finalSpecMask);
							break;
							case 3:
							poiFragData.baseColor = lerp(poiFragData.baseColor, poiFragData.baseColor * specularMap * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_HighColorThemeIndex*/)) * lerp(1, poiLight.vColor[index], (0.0 /*_UseLightColor*/)), finalSpecMask);
							break;
						}
					}
					#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					float LTCGIsmoothness = (0.8 /*_LTCGI_Smoothness*/);
					...
					acc.specular *= poiThemeColor(poiMods, float4(0.04539379,0.04539379,0.04539379,1).rgb, (0 /*_LTCGI_SpecularColorThemeIndex*/));
					...
					if ((1.0 /*_LightingCapEnabled*/))
					{
						poiLight.finalLighting = min(poiLight.finalLighting, (0.8 /*_LightingCap*/));
					}
				}
				#endif
