Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/23ea108d68f5fe24db2ca8f0aec8b550"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void initPoiAudioLink(inout PoiMods poiMods)
			{
				...
				if (AudioLinkIsAvailable())
				{
					...
					poiMods.audioLink[0] = (0.5 /*_AudioLinkSmoothingBass*/)    == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 0))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (0.5 /*_AudioLinkSmoothingBass*/)   ) * 15.95, 0))[0];
					poiMods.audioLink[1] = (0.5 /*_AudioLinkSmoothingLowMid*/)  == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 1))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (0.5 /*_AudioLinkSmoothingLowMid*/) ) * 15.95, 1))[0];
					poiMods.audioLink[2] = (0.5 /*_AudioLinkSmoothingHighMid*/) == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 2))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (0.5 /*_AudioLinkSmoothingHighMid*/)) * 15.95, 2))[0];
					poiMods.audioLink[3] = (0.5 /*_AudioLinkSmoothingTreble*/)  == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 3))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (0.5 /*_AudioLinkSmoothingTreble*/) ) * 15.95, 3))[0];
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0.004694835,0,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0.004694835,0,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(1,0.004694835,0,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,1,0,0), (0.0 /*_EmissionAL0StrengthBand*/), float4(0,1,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), (1.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.0 /*_AudioLinkEmission0CenterOutSize*/), (3.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL0Enabled*/), (1.0 /*_AudioLinkEmission0CenterOutDuration*/));
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.05793875,0.8209883,0.8773585,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.05793875,0.8209883,0.8773585,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap1*/)).rgb * poiThemeColor(poiMods, float4(0.05793875,0.8209883,0.8773585,1).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength1, float4(0,2,0,0), (1.0 /*_EmissionAL1StrengthBand*/), float4(1,1,0,0), (1.0 /*_EmissionAL1MultipliersBand*/), (1.0 /*_EmissionAL1Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength1, (0.0 /*_AudioLinkEmission1CenterOutSize*/), (3.0 /*_AudioLinkEmission1CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL1Enabled*/), (1.0 /*_AudioLinkEmission1CenterOutDuration*/));
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0.5775806,0.03954625,0.07421358,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0.5775806,0.03954625,0.07421358,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap2*/)).rgb * poiThemeColor(poiMods, float4(0.5775806,0.03954625,0.07421358,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength2, float4(0,2,0,0), (0.0 /*_EmissionAL2StrengthBand*/), float4(0,1,0,0), (0.0 /*_EmissionAL2MultipliersBand*/), (1.0 /*_EmissionAL2Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength2, (0.0 /*_AudioLinkEmission2CenterOutSize*/), (0.0 /*_AudioLinkEmission2CenterOutBand*/), float4(0,1,0,0), (1.0 /*_EmissionAL2Enabled*/), (1.0 /*_AudioLinkEmission2CenterOutDuration*/));
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.5775806,0.03954625,0.07421358,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.5775806,0.03954625,0.07421358,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap3*/)).rgb * poiThemeColor(poiMods, float4(0.5775806,0.03954625,0.07421358,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
				...
				applyALEmmissionStrength(poiMods, emissionStrength3, float4(0,2,0,0), (3.0 /*_EmissionAL3StrengthBand*/), float4(0,1,0,0), (3.0 /*_EmissionAL3MultipliersBand*/), (1.0 /*_EmissionAL3Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength3, (0.0 /*_AudioLinkEmission3CenterOutSize*/), (2.0 /*_AudioLinkEmission3CenterOutBand*/), float4(0,0,0,0), (1.0 /*_EmissionAL3Enabled*/), (1.0 /*_AudioLinkEmission3CenterOutDuration*/));
