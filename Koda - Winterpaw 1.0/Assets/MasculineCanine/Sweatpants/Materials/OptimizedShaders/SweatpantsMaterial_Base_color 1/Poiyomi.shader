Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/706506aa096e472439e3270668569782"
{
	Properties
	{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (1.0)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = 1.0 ? min(0.8, unity_LightColor[index].rgb) : unity_LightColor[index].rgb;
				...
				poiLight.directColor = 1.0 ? min(0.8, _LightColor0.rgb) : _LightColor0.rgb;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
