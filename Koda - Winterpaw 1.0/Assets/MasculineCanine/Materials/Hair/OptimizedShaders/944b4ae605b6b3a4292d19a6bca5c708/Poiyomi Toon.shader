Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/944b4ae605b6b3a4292d19a6bca5c708"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor0 = hueShift(emissionColor0, frac((1.0 /*_EmissionHueShift*/) + (3.0 /*_EmissionHueShiftSpeed*/) * _Time.x), (0.0 /*_EmissionHueShiftColorSpace*/), (1.0 /*_EmissionHueSelectOrShift*/));
