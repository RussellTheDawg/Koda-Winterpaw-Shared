Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/9add7f140627e4b44907d9f0a8e4e764"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(1,4,0,0), (1.0 /*_EmissionAL0StrengthBand*/), float4(0,3,0,0), (1.0 /*_EmissionAL0MultipliersBand*/), _EmissionAL0Enabled);
				...
				if (_ScrollingEmission)
				{
					...
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,-10,0,0).xyz, (10.0 /*_EmissiveScroll_Velocity*/), (20.0 /*_EmissiveScroll_Interval*/), (2.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
			...
			{
				float smoothness = (0.607 /*_MochieRoughnessMultiplier*/);
				...
				specularMask *= (0.75 /*_MochieSpecularStrength*/);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, (0.581 /*_RefSpecFresnelStrength*/)) * (0.581 /*_RefSpecFresnelStrength*/), pbrNDotV);
