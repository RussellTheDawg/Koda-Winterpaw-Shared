Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/823660624da2a6c42bb9116507e6288c"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				if ((3.0 /*_MainHueGlobalMask*/) > 0)
				{
					hueShiftAlpha.r = maskBlend(hueShiftAlpha.r, poiMods.globalMask[(3.0 /*_MainHueGlobalMask*/)-1], (0.0 /*_MainHueGlobalMaskBlendType*/));
				}
