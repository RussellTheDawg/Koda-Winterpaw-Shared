Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/ed76ac72be4229243ba3964930da9c83"
{
	Properties
	{
 ...
 #define PROP_CLOTHMETALLICSMOOTHNESSMAP 
 #define PROP_MATCAP 
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.5 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (2.0 /*_MatcapMaskGlobalMask*/), (0.0 /*_MatcapMaskGlobalMaskBlendType*/));
				#endif
			}
			#endif
