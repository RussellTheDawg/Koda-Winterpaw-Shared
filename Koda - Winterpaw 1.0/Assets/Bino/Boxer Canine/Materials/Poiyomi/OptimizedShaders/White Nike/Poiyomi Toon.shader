Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/4cbb07d181d1cb241836a6e7573dabf7"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					metallic = customBlend(metallic, poiMods.globalMask[(0.0 /*_MochieMetallicGlobalMask*/) - 1], (0.0 /*_MochieMetallicGlobalMaskBlendType*/));
				}
				if ((0.0 /*_MochieSmoothnessGlobalMask*/) > 0)
				{
					smoothness = customBlend(smoothness, poiMods.globalMask[(0.0 /*_MochieSmoothnessGlobalMask*/) - 1], (0.0 /*_MochieSmoothnessGlobalMaskBlendType*/));
					smoothness2 = customBlend(smoothness2, poiMods.globalMask[(0.0 /*_MochieSmoothnessGlobalMask*/) - 1], (0.0 /*_MochieSmoothnessGlobalMaskBlendType*/));
				}
				if ((0.0 /*_MochieReflectionStrengthGlobalMask*/) > 0)
				{
					reflectionMask = customBlend(reflectionMask, poiMods.globalMask[(0.0 /*_MochieReflectionStrengthGlobalMask*/) - 1], (0.0 /*_MochieReflectionStrengthGlobalMaskBlendType*/));
				}
				if ((0.0 /*_MochieSpecularStrengthGlobalMask*/) > 0)
				{
					specularMask = customBlend(specularMask, poiMods.globalMask[(0.0 /*_MochieSpecularStrengthGlobalMask*/) - 1], (0.0 /*_MochieSpecularStrengthGlobalMaskBlendType*/));
				}
				#ifdef TPS_Penetrator
