Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/4cbb07d181d1cb241836a6e7573dabf7"
{
	Properties
	{
		...
		[sRGBWarning]_GlobalMaskTexture0 ("Global Mask Texture 1--{reference_properties:[_GlobalMaskTexture0Pan, _GlobalMaskTexture0SplitTilingOffset_G, _GlobalMaskTexture0SplitPan_G, _GlobalMaskTexture0SplitTilingOffset_B, _GlobalMaskTexture0SplitPan_B, _GlobalMaskTexture0SplitTilingOffset_A, _GlobalMaskTexture0SplitPan_A, _GlobalMaskTexture0Split, _GlobalMaskTexture0UV]}", 2D) = "white" { }
		...
		[sRGBWarning]_GlobalMaskTexture1 ("Global Mask Texture 2--{reference_properties:[_GlobalMaskTexture1Pan, _GlobalMaskTexture1SplitTilingOffset_G, _GlobalMaskTexture1SplitPan_G, _GlobalMaskTexture1SplitTilingOffset_B, _GlobalMaskTexture1SplitPan_B, _GlobalMaskTexture1SplitTilingOffset_A, _GlobalMaskTexture1SplitPan_A, _GlobalMaskTexture1Split, _GlobalMaskTexture1UV]}", 2D) = "white" { }
		...
		[sRGBWarning]_GlobalMaskTexture3 ("Global Mask Texture 4--{reference_properties:[_GlobalMaskTexture3Pan, _GlobalMaskTexture3SplitTilingOffset_G, _GlobalMaskTexture3SplitPan_G, _GlobalMaskTexture3SplitTilingOffset_B, _GlobalMaskTexture3SplitPan_B, _GlobalMaskTexture3SplitTilingOffset_A, _GlobalMaskTexture3SplitPan_A, _GlobalMaskTexture3Split, _GlobalMaskTexture3UV]}", 2D) = "white" { }
 ...
 #define PROP_GLOBALMASKTEXTURE2 
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = max(UNITY_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, indirectLight).xyz, (0.248 /*_LightingMinLightBrightness*/));
				#endif
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				if ((1.0 /*_MochieMetallicGlobalMask*/) > 0)
				{
					metallic = customBlend(metallic, poiMods.globalMask[(1.0 /*_MochieMetallicGlobalMask*/) - 1], (0.0 /*_MochieMetallicGlobalMaskBlendType*/));
				}
				if ((2.0 /*_MochieSmoothnessGlobalMask*/) > 0)
				{
					smoothness = customBlend(smoothness, poiMods.globalMask[(2.0 /*_MochieSmoothnessGlobalMask*/) - 1], (0.0 /*_MochieSmoothnessGlobalMaskBlendType*/));
					smoothness2 = customBlend(smoothness2, poiMods.globalMask[(2.0 /*_MochieSmoothnessGlobalMask*/) - 1], (0.0 /*_MochieSmoothnessGlobalMaskBlendType*/));
				}
				if ((3.0 /*_MochieReflectionStrengthGlobalMask*/) > 0)
				{
					reflectionMask = customBlend(reflectionMask, poiMods.globalMask[(3.0 /*_MochieReflectionStrengthGlobalMask*/) - 1], (0.0 /*_MochieReflectionStrengthGlobalMaskBlendType*/));
				}
				if ((4.0 /*_MochieSpecularStrengthGlobalMask*/) > 0)
				{
					specularMask = customBlend(specularMask, poiMods.globalMask[(4.0 /*_MochieSpecularStrengthGlobalMask*/) - 1], (0.0 /*_MochieSpecularStrengthGlobalMaskBlendType*/));
				}
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				if ((11.0 /*_ClearCoatGlobalMask*/) > 0)
				{
					clearCoatMask = customBlend(reflectionMask, poiMods.globalMask[(11.0 /*_ClearCoatGlobalMask*/) - 1], (0.0 /*_ClearCoatGlobalMaskBlendType*/));
				}
				if ((10.0 /*_ClearCoatSmoothnessGlobalMask*/) > 0)
				{
					smoothness = customBlend(smoothness, poiMods.globalMask[(10.0 /*_ClearCoatSmoothnessGlobalMask*/) - 1], (0.0 /*_ClearCoatSmoothnessGlobalMaskBlendType*/));
				}
				if ((12.0 /*_ClearCoatReflectionStrengthGlobalMask*/) > 0)
				{
					reflectionMask = customBlend(reflectionMask, poiMods.globalMask[(12.0 /*_ClearCoatReflectionStrengthGlobalMask*/) - 1], (0.0 /*_ClearCoatReflectionStrengthGlobalMaskBlendType*/));
				}
				if ((9.0 /*_ClearCoatSpecularStrengthGlobalMask*/) > 0)
				{
					specularMask = customBlend(specularMask, poiMods.globalMask[(9.0 /*_ClearCoatSpecularStrengthGlobalMask*/) - 1], (0.0 /*_ClearCoatSpecularStrengthGlobalMaskBlendType*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				if ((4.0 /*_LightDataAOGlobalMaskR*/) > 0)
				{
					poiLight.occlusion = maskBlend(poiLight.occlusion, poiMods.globalMask[(4.0 /*_LightDataAOGlobalMaskR*/) - 1], (0.0 /*_LightDataAOGlobalMaskBlendTypeR*/));
				}
				#if defined(PROP_LIGHTINGDETAILSHADOWMAPS) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				if ((4.0 /*_LightDataDetailShadowGlobalMaskR*/) > 0)
				{
					poiLight.detailShadow = maskBlend(poiLight.detailShadow, poiMods.globalMask[(4.0 /*_LightDataDetailShadowGlobalMaskR*/) - 1], (0.0 /*_LightDataDetailShadowGlobalMaskBlendTypeR*/));
				}
				#if defined(PROP_LIGHTINGSHADOWMASKS) || !defined(OPTIMIZER_ENABLED)
				...
				{
					poiLight.directColor = max(poiLight.directColor, (0.248 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor = max(poiLight.directColor, poiLight.directColor * min(10000, ((0.248 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.directColor)))));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor * min(10000, ((0.248 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.indirectColor)))));
				}
				...
				{
					poiLight.directColor = min(poiLight.directColor, (0.72 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (0.72 /*_LightingCap*/));
				}
