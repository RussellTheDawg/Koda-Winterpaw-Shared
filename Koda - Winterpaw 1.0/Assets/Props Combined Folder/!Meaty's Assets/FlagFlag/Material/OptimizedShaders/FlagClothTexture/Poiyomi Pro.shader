Shader "Hidden/Locked/.poiyomi/Poiyomi Pro/d384e6e7090a534458c38fa9f7623053"
{
	Properties
	{
		[HideInInspector] shader_master_label ("<color=#E75898ff>Poiyomi 9.2.1</color>", Float) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = max(POI_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, indirectLight).xyz, (0.001 /*_LightingMinLightBrightness*/));
				#endif
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalSideOffset = float4(-0.3149836,0,0,-0.06800252);
				Decal0.m_DecalPosition = float4(0.3179776,0.5010269,0,0);
				...
				Decal0.m_AudioLinkDecalScale = float4(0,0,0.1,0.1);
				Decal0.m_AudioLinkDecalRotationBand = (0.0 /*_AudioLinkDecal0RotationBand*/);
				Decal0.m_AudioLinkDecalRotation = float4(0,0.5,0,0);
				...
				Decal0.m_DecalRotationCTALType = (1.0 /*_DecalRotationCTALType0*/);
				...
				Decal1.m_DecalSideOffset = float4(0,-0.3142369,0,-0.002727568);
				Decal1.m_DecalPosition = float4(0.6408997,0.5027258,0,0);
				...
				Decal1.m_AudioLinkDecalScale = float4(0,0,0.2,0.2);
				Decal1.m_AudioLinkDecalRotationBand = (0.0 /*_AudioLinkDecal1RotationBand*/);
				Decal1.m_AudioLinkDecalRotation = float4(0.2,3,0,0);
				...
				Decal1.m_DecalRotationCTALType = (1.0 /*_DecalRotationCTALType1*/);
				...
				Decal2.m_DecalRotation = (22.0 /*_DecalRotation2*/);
				Decal2.m_DecalScale = float4(1.2,1.2,1,0);
				Decal2.m_DecalSideOffset = float4(-0.1998265,0,0.002625505,0.03751361);
				Decal2.m_DecalPosition = float4(0.4657531,0.5149917,0,0);
				...
				Decal2.m_AudioLinkDecalScale = float4(0,0,0.1,0.1);
				Decal2.m_AudioLinkDecalRotationBand = (1.0 /*_AudioLinkDecal2RotationBand*/);
				Decal2.m_AudioLinkDecalRotation = float4(1,5,0,0);
				...
				Decal2.m_DecalRotationCTALType = (1.0 /*_DecalRotationCTALType2*/);
				...
				Decal3.m_DecalScale = float4(1.2,1.2,1,0);
				Decal3.m_DecalSideOffset = float4(-0.1051533,-0.2774808,0,0.03891792);
				Decal3.m_DecalPosition = float4(0.6712324,0.3391826,0,0);
				...
				Decal3.m_AudioLinkDecalScale = float4(0,0,0.1,0.1);
				Decal3.m_AudioLinkDecalRotationBand = (0.0 /*_AudioLinkDecal3RotationBand*/);
				Decal3.m_AudioLinkDecalRotation = float4(0,0.5,0,0);
				...
				Decal3.m_DecalRotationCTALType = (1.0 /*_DecalRotationCTALType3*/);
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float maskVolume = (20.0 /*_ALDecalVolumeStep*/) != 0.0 ? floor(maskY * (20.0 /*_ALDecalVolumeStep*/)) / (20.0 /*_ALDecalVolumeStep*/) : maskY;
				...
				audioLinkMask.b = maskVolume < (0.0 /*_ALDecalVolumeClipMin*/) || maskVolume > (0.981 /*_ALDecalVolumeClipMax*/) ? 0.0 : audioLinkMask.b;
				...
				if ((1.0 /*_ALDecalShapeClip*/))
				{
					...
					if ((20.0 /*_ALDecalVolumeStep*/) != 0.0) audioLinkMask.b = frac(maskY * (20.0 /*_ALDecalVolumeStep*/)) > volumeth ? 0.0 : audioLinkMask.b;
				...
				float audioVal = audioTexture.b * (0.3 /*_ALDecalVolume*/) * lerp((2.0 /*_ALDecalBaseBoost*/), (1.0 /*_ALDecalTrebleBoost*/), audioLinkMask.g);
				float audioLinkValue = (0.1 /*_ALDecalLineWidth*/) < 1.0 ? abs(audioVal - audioLinkMask.r) < (0.1 /*_ALDecalLineWidth*/) : audioVal > audioLinkMask.r * 2.0;
				...
				if ((0.0 /*_ALDecalVolumeColorSource*/) == 1) volumeColorSrc = audioLinkMask.r;
				if ((0.0 /*_ALDecalVolumeColorSource*/) == 2) volumeColorSrc = audioVal;
				float3 lowColor = float4(1,1,1,1).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (5.0 /*_ALDecalVolumeColorLowThemeIndex*/));
				float3 midColor = float4(1,1,1,1).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (6.0 /*_ALDecalVolumeColorMidThemeIndex*/));
				float3 highColor = float4(1,1,1,1).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (7.0 /*_ALDecalVolumeColorHighThemeIndex*/));
			...
			float CalculateAmbientOcclusion(float2 uv, float depth, float3 normal, float radius, float4 worldDirection, PoiMesh poiMesh, PoiCam poiCam)
			{
				...
				int totalSamples = int((2.4 /*_SSAOQuality*/) * AO_DIRECTIONS * smoothstep((8.0 /*_SSAOFalloffEnd*/), (6.0 /*_SSAOFalloffStart*/), poiCam.clipPos.w));
				...
				{
					int i = sampleIndex / int((2.4 /*_SSAOQuality*/));
					int j = sampleIndex % int((2.4 /*_SSAOQuality*/));
					float distance = (float(j) * (1.0 / ((2.4 /*_SSAOQuality*/) - 1))) + randomValue;
					float sampleAngle = (TWO_PI * (float(i) / AO_DIRECTIONS + float(j + 1) / (2.4 /*_SSAOQuality*/))) + randomValue;
					float s, c;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(unity_LightColor[index].rgb * poiLight.vAttenuation[index], (1.3 /*_LightingAdditiveLimit*/)) : unity_LightColor[index].rgb * poiLight.vAttenuation[index];
				...
				{
					poiLight.directColor = max(poiLight.directColor, (0.001 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor = max(poiLight.directColor, poiLight.directColor * min(10000, ((0.001 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.directColor)))));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor * min(10000, ((0.001 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.indirectColor)))));
				}
				poiLight.directColor = lerp(poiLight.directColor, dot(poiLight.directColor, float3(0.299, 0.587, 0.114)), (0.4 /*_LightingMonochromatic*/));
				poiLight.indirectColor = lerp(poiLight.indirectColor, dot(poiLight.indirectColor, float3(0.299, 0.587, 0.114)), (0.4 /*_LightingMonochromatic*/));
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(_LightColor0.rgb * poiLight.attenuation, (1.3 /*_LightingAdditiveLimit*/)) : _LightColor0.rgb * poiLight.attenuation;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				poiLight.indirectColor = 0;
				#else
				poiLight.indirectColor = lerp(0, poiLight.directColor, (0.5 /*_LightingAdditivePassthrough*/));
				poiLight.indirectColor = (1.0 /*_LightingAdditiveLimited*/) ? MaxLuminance(poiLight.indirectColor, (1.3 /*_LightingAdditiveLimit*/)) : poiLight.indirectColor;
				#endif
