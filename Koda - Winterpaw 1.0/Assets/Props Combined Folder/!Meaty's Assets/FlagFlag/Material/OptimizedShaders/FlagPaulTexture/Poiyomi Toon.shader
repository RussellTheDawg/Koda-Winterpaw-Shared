Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/5412104bb3672be4f8cfa37edb6bf727"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				specularMask *= (3.24 /*_MochieSpecularStrength*/);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, (0.456 /*_RefSpecFresnelStrength*/)) * (0.456 /*_RefSpecFresnelStrength*/), pbrNDotV);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.04330233,0.04330233,0.04330233,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.04330233,0.04330233,0.04330233,1).a;
