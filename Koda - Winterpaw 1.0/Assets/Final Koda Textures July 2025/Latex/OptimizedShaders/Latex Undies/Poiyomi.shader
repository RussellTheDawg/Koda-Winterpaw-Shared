Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/1193315f446061f4c88fc0064f46858f"
{
	Properties
	{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? min((0.8 /*_LightingAdditiveLimit*/), unity_LightColor[index].rgb) : unity_LightColor[index].rgb;
