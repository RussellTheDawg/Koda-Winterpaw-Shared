Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/65d0cc99188a9034dba347bea9cfb9b9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					distanceOffset *= lerp(1.0, clamp((distance(_WorldSpaceCameraPos, mul(unity_ObjectToWorld, o.localPos).xyz)), 0.0f, (0.2 /*_OutlinesMaxDistance*/)), (0.1 /*_OutlineFixWidth*/));
				}
				...
				if (canGlitch)
				{
					...
					#if defined(POI_VERTEX_GLITCHING_TEXTURE)
					float uvl = o.worldPos.y * (10.0 /*_VertexGlitchDensity*/) + _Time.x * (10.0 /*_VertexGlitchMapPanSpeed*/);
					float uvr = o.worldPos.y * (10.0 /*_VertexGlitchDensity*/) - _Time.x * (10.0 /*_VertexGlitchMapPanSpeed*/);
					...
					#endif
					float time = _Time.y * (1.0 /*_VertexGlitchFrequency*/);
					...
					if (AudioLinkIsAvailable() && (0.0 /*_VertexGlitchingAudioLinkEnabled*/))
					{
						...
						{
							glitchOffset = glitchAmount * glitchDirection * ((1.0 /*_VertexGlitchStrength*/) * .01) * audioIntensity;
						} else {
							glitchOffset = glitchAmount * glitchDirection * ((1.0 /*_VertexGlitchStrength*/) * .01) * step((1.0 /*_VertexGlitchThreshold*/), randomGlitch);
							glitchOffset += glitchAmount * glitchDirection * ((1.0 /*_VertexGlitchStrength*/) * .01) * audioIntensity;
						}
					} else {
						glitchOffset = glitchAmount * glitchDirection * ((1.0 /*_VertexGlitchStrength*/) * .01) * step((1.0 /*_VertexGlitchThreshold*/), randomGlitch);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalScale = float4(0.12,0.12,0,0);
				Decal0.m_DecalSideOffset = float4(0,0,0,0);
				Decal0.m_DecalPosition = float4(0.293,0.874,0,0);
				...
				Decal0.m_DecalChannelSeparation = (21.0 /*_Decal0ChannelSeparation*/);
				...
				Decal1.m_DecalPosition = float4(0.49475,0.5015,0,0);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float mipCount0 = 9;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 8192) mipCount0 = 13;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 4096) mipCount0 = 12;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 2048) mipCount0 = 11;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 1024) mipCount0 = 10;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 512) mipCount0 = 9;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 256) mipCount0 = 8;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 128) mipCount0 = 7;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 64) mipCount0 = 6;
					if (float4(0.0004882813,0.0004882813,2048,2048).z == 32) mipCount0 = 5;
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,8,0,0), (3.0 /*_EmissionAL0StrengthBand*/), float4(1,5,0,0), (3.0 /*_EmissionAL0MultipliersBand*/), (1.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (1.0 /*_AudioLinkEmission0CenterOutSize*/), (0.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,20,0,0), (1.0 /*_EmissionAL0Enabled*/), (1.0 /*_AudioLinkEmission0CenterOutDuration*/));
				...
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (10.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				...
				if ((0.0 /*_ScrollingEmission*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(0,-1.37,0,0).xyz) * (20.0 /*_EmissiveScroll_Interval*/)) + _Time.x * (10.0 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,-1.37,0,0).xyz, (10.0 /*_EmissiveScroll_Velocity*/), (20.0 /*_EmissiveScroll_Interval*/), (10.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
				if ((0.0 /*_EmissionBlinkingEnabled*/))
				{
					emissionStrength0 *= calculateBlinkingEmission((0.5 /*_EmissiveBlink_Min*/), (1.0 /*_EmissiveBlink_Max*/), (1.0 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
				}
				if((0.0 /*_EmissionHueShiftEnabled*/))
				{
					...
					emissionColor0 = lerp(emissionColor0, dot(emissionColor0, float3(0.3, 0.59, 0.11)), - ((-0.55 /*_EmissionSaturation*/)));
				}
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
			...
			float3 applyEmission2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength2 = (0.8 /*_EmissionStrength2*/);
				...
				{
					emissionColor2 = POI2D_SAMPLER_PAN(_EmissionMap2, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap2UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.05098039,0.05098039,0.05098039,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				else
				{
					emissionColor2 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap2, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed2*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.05098039,0.05098039,0.05098039,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				}
				#else
				emissionColor2 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.05098039,0.05098039,0.05098039,1).rgb, (0.0 /*_EmissionColor2ThemeIndex*/));
				#endif
			...
			float3 applyEmission3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionStrength3 = (0.8 /*_EmissionStrength3*/);
				...
				{
					emissionColor3 = POI2D_SAMPLER_PAN(_EmissionMap3, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap3UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.1137255,0.1137255,0.1137255,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				else
				{
					emissionColor3 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap3, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed3*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.1137255,0.1137255,0.1137255,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				}
				#else
				emissionColor3 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.1137255,0.1137255,0.1137255,1).rgb, (0.0 /*_EmissionColor3ThemeIndex*/));
				#endif
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.7991028,0.7991028,0.02842599,1);
				#ifdef POI_AUDIOLINK
				if ((1.0 /*_OutlineALColorEnabled*/) && poiMods.audioLinkAvailable)
				{
					outlineColor = lerp(outlineColor, float4(0.6231937,0.1721738,0.01459801,1), smoothstep(float4(0,4,0,0).x, float4(0,4,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkOutlineColorBand*/)]));
				}
				#endif
