Shader "Hidden/Locked/.poiyomi/Old Versions/8.1/Poiyomi Toon/dae80ab594c5b984aae4b754e06141a0"
{
	Properties
	{
		...
		[sRGBWarning]_DetailMask ("Detail Mask (Expand)--{reference_properties:[_DetailMaskPan, _DetailMaskUV, _DetailMaskStochastic]}", 2D) = "white" { }
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * lerp(1, FresnelLerp(specCol, grazingTerm, pbrNDotV), (0.899 /*_RefSpecFresnel*/));
