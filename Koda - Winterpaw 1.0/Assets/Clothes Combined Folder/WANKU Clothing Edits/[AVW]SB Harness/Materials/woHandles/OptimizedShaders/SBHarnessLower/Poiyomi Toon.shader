Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/340aaf04437866d4ca2ccf3e910a3e57"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,1,0,0), 0.0, float4(0,0,0,0), 3.0, _EmissionAL0Enabled);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, 0.241, 1.0, float4(0,3,0,0), _EmissionAL0Enabled, -0.632);
			...
			float3 applyEmission__1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0__1 = emissionTex__1.rgb * lerp(1, poiFragData.baseColor, mixBaseColor__1).rgb * poiThemeColor(poiMods, float4(1.39772,1.39772,1.39772,0).rgb, 0.0);
				emissionAlpha__1 = emissionTex__1.a;
				#else
				emissionColor0__1 = lerp(1, poiFragData.baseColor, mixBaseColor__1).rgb * poiThemeColor(poiMods, float4(1.39772,1.39772,1.39772,0).rgb, 0.0);
				#endif
				...
				if (0.0)
				{
					emissionStrength0__1 *= calculateBlinkingEmission__1(0.0, 2.0, 0.75, 0.0);
				}
				if(0.0)
				{
