Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/950509a2e42ca9a4e8178090e75ad798"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				{
					poiMods.detailMask.r = customBlend(poiMods.detailMask.r, poiMods.globalMask[(0.0 /*_DetailTexGlobalMask*/)-1], (2.0 /*_DetailTexGlobalMaskBlendType*/));
				}
				if ((0.0 /*_DetailNormalGlobalMask*/) > 0)
				{
					poiMods.detailMask.g = customBlend(poiMods.detailMask.g, poiMods.globalMask[(0.0 /*_DetailNormalGlobalMask*/)-1], (2.0 /*_DetailNormalGlobalMaskBlendType*/));
				}
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(5,5,0,0)), float4(0,0,0,0), (0.0 /*_DetailNormalMapStochastic*/)), (0.4 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				float shadowStrength = (0.7 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				...
				poiLight.finalLighting = lerp(float4(1,1,1,1) * lerp(poiLight.indirectColor, poiLight.rampedLightMap * poiLight.directColor, (0.4 /*_LightingIgnoreAmbientColor*/)) * poiLight.occlusion, poiLight.directColor, poiLight.rampedLightMap);
				#endif
				#endif
				#ifdef POI_PASS_ADD
