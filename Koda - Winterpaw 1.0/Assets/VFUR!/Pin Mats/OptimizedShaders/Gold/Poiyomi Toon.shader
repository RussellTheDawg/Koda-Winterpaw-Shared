Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/fe470c371332582489659cafa0aed7ae"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = max(poiLight.directColor, (0.8 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor = max(poiLight.directColor, poiLight.directColor * min(10000, ((0.8 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.directColor)))));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor * min(10000, ((0.8 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.indirectColor)))));
				}
				...
				{
					poiLight.directColor = min(poiLight.directColor, (0.3 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (0.3 /*_LightingCap*/));
				}
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.8,0.8,0.8,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.8,0.8,0.8,1).a;
