Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/d52ea4c42eef80344b87cb0fdfa9c700"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.149 /*_AlphaMod*/));
			...
			{
				float smoothness = (0.72 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (0.877 /*_MochieRoughnessMultiplier2*/);
				...
				#endif
				reflectionMask *= (0.163 /*_MochieReflectionStrength*/);
			...
			void applyNormalCorrect(inout VertexOut i)
			{
				...
				i.normal.xyz = normalize(lerp(i.normal.xyz, normalCorrectWorld, (0.088 /*_NormalCorrectAmount*/)));
				i.objNormal.xyz = normalize(lerp(i.objNormal.xyz, normalCorrectObject, (0.088 /*_NormalCorrectAmount*/)));
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.3812781,0.3812781,0.3812781,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.3812781,0.3812781,0.3812781,1).a;
