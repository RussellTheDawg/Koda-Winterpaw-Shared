Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/a9e32489b41d4584faaffd5a983f9b78"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = max(UNITY_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, indirectLight).xyz, (0.14 /*_LightingMinLightBrightness*/));
				#endif
				#endif
				#ifdef POI_PASS_ADD
			...
			{
				float smoothness = (0.536 /*_MochieRoughnessMultiplier*/);
				...
				#endif
				reflectionMask *= (0.155 /*_MochieReflectionStrength*/);
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col = lerp(col, GetHDR(col), (0.3 /*_PPHDR*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = max(poiLight.directColor, (0.14 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor   = max(poiLight.directColor,   poiLight.directColor   * min(10000, ((0.14 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.directColor))  )));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor * min(10000, ((0.14 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.indirectColor)))));
				}
