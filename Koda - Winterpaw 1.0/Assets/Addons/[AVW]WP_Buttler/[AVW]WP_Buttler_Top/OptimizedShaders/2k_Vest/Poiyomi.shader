Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/b4041c4ae7cf56540b83824b6d697d5d"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				poiLight.finalLighting = max(UNITY_BRDF_PBS(1, 0, 0, 0, poiMesh.normals[1], poiCam.viewDir, light, indirectLight).xyz, (0.04 /*_LightingMinLightBrightness*/));
				#endif
				#endif
				#ifdef POI_PASS_ADD
			...
			{
				float smoothness = (0.571 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (0.426 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.333 /*_MochieMetallicMultiplier*/);
				...
				#endif
				reflectionMask *= (0.116 /*_MochieReflectionStrength*/);
				specularMask *= (0.639 /*_MochieSpecularStrength*/);
				...
				if ((1.0 /*_MochieGSAAEnabled*/))
				{
					...
					if ((1.0 /*_Specular2ndLayer*/) == 1 && (0.639 /*_MochieSpecularStrength2*/) > 0)
					{
				...
				if ((1.0 /*_Specular2ndLayer*/) == 1)
				{
					...
					specular2 = poiLight.directColor * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * attenuation * (0.639 /*_MochieSpecularStrength2*/);
					#if defined(VERTEXLIGHT_ON) && defined(POI_VERTEXLIGHT_ON)
					for (int index = 0; index < 4; index++)
					{
						fresnelTerm = 1;
						...
						vSpecular2 += poiLight.vColor[index] * specularTerm * fresnelTerm * specularMask * poiThemeColor(poiMods, float4(1,1,1,1), (0.0 /*_MochieSpecularTintThemeIndex*/)) * poiLight.occlusion * poiLight.vAttenuation[index] * (0.639 /*_MochieSpecularStrength2*/);
					}
					#endif
				}
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col = lerp(col, GetHDR(col), (0.4 /*_PPHDR*/));
			...
			void applyNormalCorrect(inout VertexOut i)
			{
				...
				i.normal.xyz = normalize(lerp(i.normal.xyz, normalCorrectWorld, (0.141 /*_NormalCorrectAmount*/)));
				i.objNormal.xyz = normalize(lerp(i.objNormal.xyz, normalCorrectObject, (0.141 /*_NormalCorrectAmount*/)));
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = max(poiLight.directColor, (0.04 /*_LightingMinLightBrightness*/));
				}
				else
				{
					poiLight.directColor   = max(poiLight.directColor,   poiLight.directColor   * min(10000, ((0.04 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.directColor))  )));
					poiLight.indirectColor = max(poiLight.indirectColor, poiLight.indirectColor * min(10000, ((0.04 /*_LightingMinLightBrightness*/) * rcp(calculateluminance(poiLight.indirectColor)))));
				}
				...
				poiFragData.baseColor = saturate(poiFragData.baseColor + (0.01 /*_MainBrightness*/) * hueShiftAlpha.g);
				#endif
