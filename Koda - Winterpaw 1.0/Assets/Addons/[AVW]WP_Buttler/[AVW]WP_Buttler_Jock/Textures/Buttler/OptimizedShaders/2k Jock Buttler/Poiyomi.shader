Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/172bbd61ff0874f4cb5db5cef3ee28a5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness2 = (0.741 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.352 /*_MochieMetallicMultiplier*/);
				...
				metallic *= PBRMaps[(1.0 /*_MochieMetallicMapsMetallicChannel*/)];
				...
				#endif
				reflectionMask *= (0.136 /*_MochieReflectionStrength*/);
			...
			void applyPostProcessing(inout PoiFragData poiFragData, in PoiMesh poiMesh)
			{
				...
				col = lerp(col, GetHDR(col), (0.0 /*_PPHDR*/));
			...
			void applyNormalCorrect(inout VertexOut i)
			{
				...
				i.normal.xyz = normalize(lerp(i.normal.xyz, normalCorrectWorld, (0.272 /*_NormalCorrectAmount*/)));
				i.objNormal.xyz = normalize(lerp(i.objNormal.xyz, normalCorrectObject, (0.272 /*_NormalCorrectAmount*/)));
			}
			#endif
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.461 /*_Cutoff*/));
