Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/0a8a68f5bfa207640ab9119086153316"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void initPoiAudioLink(inout PoiMods poiMods)
			{
				...
				if (AudioLinkIsAvailable())
				{
					...
					poiMods.audioLink[0] = (1.0 /*_AudioLinkSmoothingBass*/)    == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 0))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (1.0 /*_AudioLinkSmoothingBass*/)   ) * 15.95, 0))[0];
					poiMods.audioLink[1] = (1.0 /*_AudioLinkSmoothingLowMid*/)  == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 1))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (1.0 /*_AudioLinkSmoothingLowMid*/) ) * 15.95, 1))[0];
					poiMods.audioLink[2] = (1.0 /*_AudioLinkSmoothingHighMid*/) == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 2))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (1.0 /*_AudioLinkSmoothingHighMid*/)) * 15.95, 2))[0];
					poiMods.audioLink[3] = (1.0 /*_AudioLinkSmoothingTreble*/)  == 0 ? AudioLinkData(ALPASS_AUDIOLINK + float2(0, 3))[0] : AudioLinkData(ALPASS_FILTEREDAUDIOLINK + float2((1 - (1.0 /*_AudioLinkSmoothingTreble*/) ) * 15.95, 3))[0];
			...
			void ApplyBackFaceColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					float4 backFaceColor = float4(1,1,1,1);
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				else if ((3.0 /*_LightingAdditiveType*/) == 1) // Toon
				{
					...
					float passthrough = 0;
					#else
					float passthrough = (0.55 /*_LightingAdditivePassthrough*/);
					#endif
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					{
						if ((3.0 /*_LightingAdditiveType*/) == 0 || (3.0 /*_LightingAdditiveType*/) == 3)
						{
							vertexLighting += poiLight.vColor[index] * poiLight.vAttenuationDotNL[index] * poiLight.detailShadow; // Realistic
						}
						if ((3.0 /*_LightingAdditiveType*/) == 1) // Toon
						{
							vertexLighting += lerp(poiLight.vColor[index] * poiLight.vAttenuation[index], poiLight.vColor[index] * (0.55 /*_LightingAdditivePassthrough*/) * poiLight.vAttenuation[index], smoothstep((0.0 /*_LightingAdditiveGradientStart*/), (0.5 /*_LightingAdditiveGradientEnd*/), 1 - (.5 * poiLight.vDotNL[index] + .5))) * poiLight.detailShadow;
						}
					}
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((1.0 /*_GITDEMinLight*/), (0.957 /*_GITDEMaxLight*/), (0.067 /*_GITDEMinEmissionMultiplier*/), (1.0 /*_GITDEMaxEmissionMultiplier*/), (0.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled*/))
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.4261567,1.61217,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.4261567,1.61217,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (0.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0,0.4261567,1.61217,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				if (_ScrollingEmission)
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(0,0,10,0).xyz) * (5.0 /*_EmissiveScroll_Interval*/)) + _Time.x * (1.0 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,0,10,0).xyz, (1.0 /*_EmissiveScroll_Velocity*/), (5.0 /*_EmissiveScroll_Interval*/), (40.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,1,0,0), (1.0 /*_EmissionAL0StrengthBand*/), float4(0,1,0,0), (0.0 /*_EmissionAL0MultipliersBand*/), _EmissionAL0Enabled);
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.166 /*_AudioLinkEmission0CenterOutSize*/), (3.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,2,0,0), _EmissionAL0Enabled, (0.884 /*_AudioLinkEmission0CenterOutDuration*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if ((1.0 /*_LightingVertexLightingEnabled*/))
				{
					...
					for (int index = 0; index < 4; index++)
					{
						...
						poiLight.vColor[index] = (1.0 /*_LightingAdditiveLimited*/) ? min((1.3 /*_LightingAdditiveLimit*/), unity_LightColor[index].rgb) : unity_LightColor[index].rgb;
				...
				poiLight.directColor = (1.0 /*_LightingAdditiveLimited*/) ? min((1.3 /*_LightingAdditiveLimit*/), _LightColor0.rgb) : _LightColor0.rgb;
				#if defined(POINT_COOKIE) || defined(DIRECTIONAL_COOKIE)
				poiLight.indirectColor = 0;
				#else
				poiLight.indirectColor = lerp(0, poiLight.directColor, (0.55 /*_LightingAdditivePassthrough*/));
				#endif
