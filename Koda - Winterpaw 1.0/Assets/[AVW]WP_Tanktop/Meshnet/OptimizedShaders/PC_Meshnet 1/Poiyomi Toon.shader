Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/27756ad7e777dad409bcb635f424afc8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = min(poiLight.directColor, (8.0 /*_LightingCap*/));
					poiLight.indirectColor = min(poiLight.indirectColor, (8.0 /*_LightingCap*/));
				}
