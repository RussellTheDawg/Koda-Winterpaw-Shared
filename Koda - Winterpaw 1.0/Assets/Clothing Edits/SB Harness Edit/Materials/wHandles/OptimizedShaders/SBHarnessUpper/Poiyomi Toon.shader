Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/515e70e053b85254b8c6bbcfca45aa52"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				applyALEmmissionStrength(poiMods, emissionStrength0, float4(0,0.2,0,0), (1.0 /*_EmissionAL0StrengthBand*/), float4(0,1,0,0), (2.0 /*_EmissionAL0MultipliersBand*/), (1.0 /*_EmissionAL0Enabled*/));
				applyALCenterOutEmission(poiMods, poiLight.nDotV, emissionStrength0, (0.105 /*_AudioLinkEmission0CenterOutSize*/), (1.0 /*_AudioLinkEmission0CenterOutBand*/), float4(0,3,0,0), (1.0 /*_EmissionAL0Enabled*/), (-0.632 /*_AudioLinkEmission0CenterOutDuration*/));
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.136 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (0.514 /*_GITDEMinEmissionMultiplier*/), (0.7 /*_GITDEMaxEmissionMultiplier*/), (0.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#ifdef POI_GRABPASS
			...
			float3 applyEmission1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					emissionColor1 = POI2D_SAMPLER_PAN(_EmissionMap1, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMap1UV*/)], float4(1,1,0,0)), float4(0,0,0,0)) * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1.498039,1.498039,1.498039,0).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				else
				{
					emissionColor1 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap1, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (0.0 /*_EmissionCenterOutSpeed1*/)).rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1.498039,1.498039,1.498039,0).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				}
				#else
				emissionColor1 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(1.498039,1.498039,1.498039,0).rgb, (0.0 /*_EmissionColor1ThemeIndex*/));
				#endif
				...
				if ((0.0 /*_EmissionHueShiftEnabled1*/))
				{
					...
					emissionColor1 = lerp(emissionColor1, dot(emissionColor1, float3(0.3, 0.59, 0.11)), - ((1.0 /*_EmissionSaturation1*/)));
				}
				#if defined(PROP_EMISSIONMASK1) || !defined(OPTIMIZER_ENABLED)
